...
class UserLogsControllerTest < ActionController::TestCase
  ...
  test "should create user_log" do
    assert_difference('UserLog.count') do
      post :create, user_log: { Activity_name: @user_log.Activity_name, UID: @user_log.UID, time: @user_log.time }
    end
  ...
  test "should update user_log" do
    patch :update, id: @user_log, user_log: { Activity_name: @user_log.Activity_name, UID: @user_log.UID, time: @user_log.time }
    assert_redirected_to user_log_path(assigns(:user_log))
  end
